...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | View Sub Contract</title>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">View Sub Contract</li>
                    </ol>
                </section>
...
<style type="text/css">     
    ...
    <form action="" method="POST" enctype="multipart/form-data" accept-charset='UTF-8'>
        ...
        <div class="form-group-sm details_div">
            ...
            <div class="col-sm-8" >
                <select name="contractPackage" id="contractPackage" class="form-control" readonly>
        ...
        <div class="form-group-sm">
            ...
            <div class="input_fields_wrap">
                <div class="col-sm-8">
                    <textarea rows="5" cols="310" name="scopeWork" class="form-control" placeholder="Scope of Work" readonly>${registeredScopeWork}</textarea>
                </div>
            </div>
        </div>
        <div class="form-group-sm">
        ...
        <div class="form-group-sm">
            ...
            <div class="col-sm-8">
                <input type="text" name="subContractNo" id="subContractNo" class="form-control" placeholder="Reference Number" value="${selectedSubContractNo}" disabled>
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputSubContractAmount" class="col-sm-3 control-label">Contract Value</label>
            <div class="col-sm-8">
                <input type="text" name="subContractAmount" id="subContractAmount" class="form-control" placeholder="Contract Value" value="${selectedSubContractValue}" disabled>
            </div>
        </div>
        <div class="form-group-sm">
            ...
            <div class="input_fields_wrapEdit2">
                            <c:choose>
                            <c:when test="${insertedRevisedSubContractValue == []}">
                                <div class="form-group-sm"><label for="inputRevisedSubContractAmount" class="col-sm-3 control-label"></label><div class="col-sm-8">
                               <input type="text" name="revisedSubContractAmount" value="No Data" id="revisedSubContractAmount" class="form-control-static" style="width:400px;" placeholder="No Data" disabled>
                            ...
                            <c:otherwise>
                                ...
                                <script>
                                    var wrapperEdit = $(".input_fields_wrapEdit2");
        ...
        <div class="form-group-sm">
            ...
            <div class="col-sm-8">
                <input type="text" name="subContractDate" id="subContractDate" class="form-control-static" style="width:150px;" placeholder="Contract Duration" value="${selectedSubContractDate}" disabled>
                 <select name="dateCategory" id="dateCategory" class="form-control-static" style="width:150px;background-color:#E6E6E6" disabled>
                    <option value="">Please Select</option>
        ...
        <div class="form-group"> 
            <div class="col-sm-offset-1">
                <a href="SubContractList.jsp" style=""><font color="#000000"><input type="button" class="form-control-static" value="Back" style=""/></font></a>
            </div>
        </div>
    </form>
</div>
