...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | View Decline Contract Award</title>
...
<style type="text/css">     
    ...
    <form action="ContractAwardServlet?action=declinecontractawardreg_view"  method="POST" enctype="multipart/form-data" accept-charset='UTF-8'>
        ...
        <a data-toggle="collapse" data-target="#collapseOne" 
          ...
          View Contract Award Declination 
        </a>
      </h4>
        </div>
        ...
        <div class="form-group-sm">
            ...
            <div class="col-sm-8">
                <textarea rows="5" cols="110" name="declineReason" class="form-control" placeholder="Reason" disabled="disabled">${insertedReasonDecline}</textarea>
            </div>
        </div>
        <div class="form-group-sm">
            ...
            <div class="col-sm-8">
                <c:choose>
                    <c:when test="${insertedAttachmentDecline == []}">
                        <label for="inputInsertedAttachmentDecline" class="col-sm-9 control-label">No File</label>
                    </c:when>
                    <c:otherwise>
                        <c:forEach items="${insertedAttachmentDecline}" var="row">
                            <ul><li><a href="ContractAwardServlet?action=DownloadAttachment&fileName=${row.attachDeclineFileName}&oriFileName=${row.oriAttachDeclineFileName}&typeID=${row.attachDeclineMasterID}" >${row.oriAttachDeclineFileName}</a><br>   
                            </li></ul>
                            </c:forEach>
                    </c:otherwise>
                    </c:choose>
        ...
        <div class="form-group"> 
            <div class="col-sm-offset-1">
                <a href="DeclineContractAwardList.jsp" style=""><font color="#000000"><input type="button" class="form-control-static" value="Back" style=""/></font></a>
            </div>
        </div>
    </form>
</div>
