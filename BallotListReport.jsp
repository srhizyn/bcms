...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | Ballot List Report</title>
...
<style type="text/css">     
    ...
    <form action="ReportBallotList"  method="POST" target="_blank">
        ...
        <div class="form-group-sm">
            <label for="inputBallotStatus" class="col-sm-3 control-label">Ballot Status</label>
            <div class="col-sm-8">
                    <select name="ballotStatus" id="ballotStatus" class="form-control">
