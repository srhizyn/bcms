...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | New Decline Contract Award</title>
...
<style type="text/css">     
    ...
    <form action="ContractAwardServlet?action=declinecontractawardreg_create"  method="POST" enctype="multipart/form-data" accept-charset='UTF-8'>
        ...
        <a data-toggle="collapse" data-target="#collapseOne" 
          ...
          Contract Award Declination Registration
        </a>
      </h4>
        </div>
        ...
        <div class="form-group-sm">
            ...
            <div class="col-sm-8">
                <textarea rows="5" cols="110" name="declineReason" class="form-control" placeholder="Reason"></textarea>
            </div>
        </div>
        <div class="form-group-sm">
        ...
        <div class="form-group"> 
            <div class="col-sm-offset-1">
                <input type="submit" value="Register Decline Contract Award" id="AddDeclineContractAward" class="form-control-static" onclick="return confirm('Confirm to register contract award declination?');"/>
...
if(javascriptVar === 'true'){
    ...
    window.location = "fwdDeclineContractAwardReg.jsp";
    return true;
    }
