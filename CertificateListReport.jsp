...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | Certificate List Report</title>
...
<style type="text/css">     
    ...
    <form action="ReportCertificateList"  method="POST" target="_blank">
        ...
        <div class="form-group-sm">
            <label for="inputCertificateType" class="col-sm-3 control-label">Certificate Type</label>
            <div class="col-sm-8">
                    <select name="certificateType" id="certificateType" class="form-control">
                        <option value="">Please Select</option>
                        <option value="1">SSM</option>
                        <option value="2">STB</option>
                        <option value="3">CIDB</option>
                    </select>
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputValid" class="col-sm-3 control-label">Validity</label>
            <div class="col-sm-8">
