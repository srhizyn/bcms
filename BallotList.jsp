            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Ballot Records</li>
                    </ol>
                </section>
...
<style type="text/css">     
    ...
    <br>
    <div id="BallotTableContainer"></div>
</div>
<script type="text/javascript">
    $(document).ready(function () {
        $('#BallotTableContainer').jtable({
            title: 'Ballot',
            ...
            fields: {
                ...
                viewBallot:{
                    ...
                    display: function (data) {
                        return '<form action="BallotServlet?action=BallotView&ballotID=' + data.record.ballotID + '"  method="POST"><input type="submit" value="View" /></form>';        
                ...
                editBallot:{
                    ...
                    listClass: 'aligncenter',
                    display: function (data) {
                        return '<form action="BallotServlet?action=BallotEdit&ballotID=' + data.record.ballotID + '"  method="POST"><input type="submit" value="Edit" name="editBallot" id="editBallot"/></form>';        
