...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | Edit Contract Award</title>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Contract Award</li>
                    </ol>
                </section>
...
<style type="text/css">     
    ...
    <form action="ContractAwardServlet?action=contractawardreg_update"  method="POST" enctype="multipart/form-data" accept-charset='UTF-8'>
        ...
        <%--<div class="form-group-sm">
            <label for="inputDocRefNo" class="col-sm-3 control-label">Document Reference Number</label>
            <div class="col-sm-8">
                <input type="text" size="50" id="docRefNo" name="docRefNo" class="form-control" placeholder="Document Reference Number" value="${selectedDocRefNo}">
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputSubConContractSum" class="col-sm-3 control-label">Contract Sum</label>
            <div class="col-sm-8">
                <input type="text" size="50" id="subConContractSum" name="subConContractSum" class="form-control" placeholder="Enter Contract Sum" value="${selectedSubConContractSum}">
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputSubConRevisedContractSum" class="col-sm-3 control-label">Revised Contract Sum</label>
            <div class="col-sm-8">
                <input type="text" size="50" id="subConRevisedContractSum" name="subConRevisedContractSum" class="form-control" placeholder="Enter Revised Contract Sum" value="${selectedSubConRevisedContractSum}">
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputEotDays" class="col-sm-3 control-label">EOT Days</label>
            <div class="col-sm-8">
                <input type="text" size="50" id="eotDays" name="eotDays" class="form-control" placeholder="Enter EOT Days" value="${selectedEotDays}">
            </div>
        </div>--%>
        <div class="form-group-sm">
            <label for="inputPerformaAcceptedDate" class="col-sm-3 control-label">Pernyataan Persetujuan dan Akujanji</label>
            <div class="col-sm-8">
                <input type="date" name="performaAcceptedDate" id="performaAcceptedDate" class="form-control" value="${selectedPerformaAcceptedDate}" min="2000-01-01" max="2040-12-31">
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputLoaDate" class="col-sm-3 control-label">LOA/WO Date</label>
            <div class="col-sm-8">
                <input type="date" name="loaDate" id="loaDate" class="form-control" value="${selectedLoaDate}" min="2000-01-01" max="2040-12-31">
            </div>
        </div> 
        <div class="form-group-sm">
            <label for="inputCommencementDate" class="col-sm-3 control-label">Commencement Date</label>
            <div class="col-sm-8">
                <input type="date" name="commencementDate" id="commencementDate" class="form-control" value="${selectedCommencementDate}" min="2000-01-01" max="2040-12-31">
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputCompletionDate" class="col-sm-3 control-label">Completion Date</label>
            <div class="col-sm-8">
                <input type="date" name="completionDate" id="completionDate" class="form-control" value="${selectedCompletionDate}" min="2000-01-01" max="2040-12-31">
            </div>
        </div> 
        <div class="form-group-sm">
            <label for="inputActualCompletionDate" class="col-sm-3 control-label">Actual Completion Date</label>
            <div class="col-sm-8">
                <input type="date" name="actualCompletionDate" id="actualCompletionDate" class="form-control" min="2000-01-01" value="${selectedActualCompletionDate}" max="2040-12-31">
            </div>
        </div> 
        <div class="form-group-sm">
            <label for="inputProgressAuditDate" class="col-sm-3 control-label">Audit Date</label>
            <div class="col-sm-8">
                <input type="date" name="progressAuditDate" id="progressAuditDate" class="form-control" value="${selectedProgressAuditDate}" min="2000-01-01" max="2040-12-31">
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputFinalAccountDate" class="col-sm-3 control-label">Final Account Date</label>
            <div class="col-sm-8">
                <input type="date" name="finalAccountDate" id="finalAccountDate" class="form-control" min="2000-01-01" max="2040-12-31" value="${selectedFinalAccountDate}">
            </div>
        </div>
        <%--<div class="form-group-sm">
            <label for="inputContractAwardRemarks" class="col-sm-3 control-label">Remarks</label>
            <div class="col-sm-8">
                <textarea rows="5" cols="110" name="contractAwardRemarks" class="form-control" placeholder="Remarks">${selectedContractAwardRemarks}</textarea>
            </div>
        </div>--%>
        </div>
        </div>
        ...
        <div class="form-group"> 
            <div class="col-sm-offset-1">
                <input type="submit" value="Save Contract Award" id="SaveContractAward" class="form-control-static" onclick="return confirm('Confirm to save contract award?')"/>
...
if(javascriptVar === 'true'){
    alert("Contract Award Information Successfully Updated");
    window.location = "ContractAwardRegList.jsp";
    return true;
    }
