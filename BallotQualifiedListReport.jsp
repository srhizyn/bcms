...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | Ballot Qualified List Report</title>
...
<style type="text/css">     
    ...
    <form action="ReportContractorList"  method="POST" target="_blank">
        ...
        <div class="form-group-sm">
            ...
            <div class="col-sm-8">
                <select name="cidbGrade" id="cidbGrade" class="form-control" multiple>
            ...
            <div class="col-sm-8">
                <select name="specialisation" id="specialisation" class="form-control" multiple>
                    <option value="0" selected>ALL</option>
                            <c:forEach items="${specialisation}" var="row" >
                            <option value="${row.specialisationID}" rel="${row.groupingB}">${row.specialisationCode}</option>
                            </c:forEach>
                </select>
            </div>
        </div>
        <div class="form-group-sm">
            <label for="inputSpkkSubCat" class="col-sm-3 control-label">SPKK Sub-category</label>
            <div class="col-sm-8">
                <select name="spkkSpec" id="spkkSpec" class="form-control" multiple>
                            <option value="0" selected>ALL</option>
        ...
        <div class="form-group-sm">
            <label for="inputMof" class="col-sm-3 control-label">MOF</label>
            <div class="col-sm-8">
                <select name="mof" id="mof" multiple="multiple" class="form-control">
                            <option value="0" selected>ALL</option>
        ...
        <div class="form-group-sm">
            <label for="inputAwardStatus" class="col-sm-3 control-label">Award Status</label>
            <div class="col-sm-8">
                <select name="awardStatus" id="awardStatus"  class="form-control">
