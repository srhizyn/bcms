...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>BCMS | New Key Issues</title>
...
<style type="text/css">     
    ...
    <form action="MattersTrackingServlet?action=matterstrackingreg_create"  method="POST" enctype="multipart/form-data" accept-charset='UTF-8'>
        ...
        <div class="form-group-sm">
            ...
            <div class="col-sm-8">
                <select name="contractAward" id="contractAward" class="form-control">
        ...
        <div class="form-group"> 
            <div class="col-sm-offset-1">
                <input type="submit" value="Add Key Issues" id="AddMattersTracking" class="form-control-static" onclick="return isValidDate();return confirm('Confirm to add key issues?');"/>
                <input type="reset" value="Reset" id="ResetMattersTracking" class="form-control-static"/>
                <a href="MattersTrackingRegList.jsp" style=""><font color="#000000"><input type="button" class="form-control-static" value="Cancel" style=""/></font></a>
            </div>
        </div>
    </form>
</div>
...
if(javascriptVar === 'true'){
    alert("Key Issues Successfully Added");
