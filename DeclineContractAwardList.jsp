...
<html>
    <head>
        <meta charset="UTF-8">
        <title>BCMS | Decline Contract Award List</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Decline Contract Award Records
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="home.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Decline Contract Award Records</li>
                    </ol>
                </section>
...
<style type="text/css">     
    ...
    <br>
    <div id="DeclineContractAwardTableContainer"></div>
</div>
<script type="text/javascript">
    $(document).ready(function () {
        $('#DeclineContractAwardTableContainer').jtable({
            ...
            fields: {
                ...
                viewDeclineContractAward:{
                    ...
                    display: function (data) {
                        return '<form action="ContractAwardServlet?action=DeclineContractAwardView&declineContractAwardID=' + data.record.declineContractAwardID + '"  method="POST"><input type="submit" value="View" /></form>';        
                        
                    }
                },
                editDeclineContractAward:{
                    title:'',
                    width: '3%',
                    list: true,
                    create:false,
                    ...
                    listClass: 'aligncenter',
                    display: function (data) {
                        return '<form action="ContractAwardServlet?action=DeclineContractAwardEdit&declineContractAwardID=' + data.record.declineContractAwardID + '"  method="POST"><input type="submit" value="Edit" name="editDeclineContractAward" id="editDeclineContractAward"/></form>';        
        ...
        $('#LoadRecordsButton').click(function (e) {
            e.preventDefault();
            $('#DeclineContractAwardTableContainer').jtable('load', {
